    ...
    const requirements = [
        {
            ...
            gradient: 'linear-gradient(90deg, #1DF2F2 0%, #1DF2F2 20%, #F130EE 48%, #F130EE 100%)' // Más corto
        },
        {
            ...
            gradient: 'linear-gradient(90deg, #1DF2F2 0%, #1DF2F2 30%, #F130EE 60%, #F130EE 100%)' // Original
        },
        {
            ...
            gradient: 'linear-gradient(90deg, #1DF2F2 0%, #1DF2F2 40%, #F130EE 80%, #F130EE 100%)' // Más amplio
        },
        {
            ...
            gradient: 'linear-gradient(90deg, #1DF2F2 0%, #9683F0 57%, #A378EF 57%, #F130EE 100%)' // 4 colores
        }
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {requirements.map((req, index) => (
                        ...
                        >
                            ...
                            {/* Título con Gradiente - Ancho completo */}
