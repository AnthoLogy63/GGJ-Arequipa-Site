...
**HeroSection (LUIS)**: Banner principal de la landing con el título “Game Jam 2026”, una breve descripción del evento y un contador regresivo hasta el inicio.

**CountdownSection (LUIS)**: Sección de contador regresivo que muestra el tiempo restante hasta el inicio del evento.

**AboutSection (ANTHONY)**: Sección introductoria que explica qué es la Game Jam y su propósito, acompañada de un recurso visual o ilustración temática.

**RegistrationStepsSection (ANTHONY)**: Conjunto de tarjetas informativas que muestran los pasos a seguir para registrarse en el evento

**ScheduleSection (JHEEREMY)**: Sección de cronograma que organiza las actividades del evento por fechas y días, utilizando un selector para facilitar la navegación.

**CallToActionMid (JHEEREMY)**: Bloque intermedio de llamado a la acción con un mensaje motivador y botones que invitan a registrarse o conocer más.

**LocationSection (SANDRA)**: Sección informativa que muestra la ubicación física del evento, fechas, horarios y un mapa integrado.

**BenefitsSection (SANDRA)**: Cuadrícula visual que resalta los principales beneficios de participar en la Game Jam.

**TeamSection (JESUS)**: Galería que presenta al equipo organizador mediante fotografías y cargos.

**SponsorsSection(JESUS)**: Barra o fila horizontal que muestra los logotipos de las marcas y empresas patrocinadoras del evento.

**FaqSection (FERNANDO)**: Sección de preguntas frecuentes con un sistema tipo acordeón para optimizar el espacio y la lectura.

**FinalCallToAction(JESUS)**: Banner final de cierre con un mensaje de comunidad y el último llamado a la inscripción.

---

## PAGE INSCRIPCIONES

**RegistrationHero (LUIS)**: Banner de cabecera con el título principal de registro, una descripción motivadora del evento en Arequipa y un fondo visual temático.

**RequirementsSection (FERNANDO)**: Conjunto de fichas informativas con iconos que detallan los requisitos previos para participar, como edad mínima, equipo necesario y materiales.

**RegistrationStepper (GUSTAVO)**: Componente central del proceso de inscripción que muestra los pasos del registro mediante una línea de tiempo visual, indicadores de fase y requisitos específicos por etapa.

**InstructionNotice (FERNANDO)**: Cuadro de alerta visual que resalta instrucciones críticas y reglas importantes que deben seguirse al completar los formularios.

**FinalVerificationCTA (JHEEREMY)**: Bloque de cierre del proceso de inscripción con una pregunta de validación final y botones de acción para confirmar o corregir la información ingresada.
